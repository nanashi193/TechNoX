...
export const routes: Routes = [
...

    {
        ...
        data: {hideChrome: true, title: 'Quên mật khẩu | TechNoX'}
    },
    {
        path: 'reset-password',
    ...
    {
        path: 'user/:id',
        loadComponent: () => import('./components/detail-user/detail.user').then(m => m.DetailUserComponent)
    },
    {
        path: 'profile',
        loadComponent: () => import('./components/detail-user/detail.user').then(m => m.DetailUserComponent)
...

    {
        ...
        children: [
            ...
            {
                path: 'owner/products/:id/edit', loadComponent: () =>
                    import('./components/owner/products/products-detail/products-detail.component')
                        .then(m => m.ProductsDetailComponent)
            },
            {
